...
import com.eu.arcturus.database.Database;
import com.eu.arcturus.gui.EmulatorGUI;
import com.eu.arcturus.habbohotel.GameEnvironment;
import com.eu.arcturus.habbohotel.gameclients.SessionResumeManager;
import com.eu.arcturus.networking.gameserver.GameServer;
import com.eu.arcturus.networking.rconserver.RCONServer;
import com.eu.arcturus.plugin.PluginManager;
...
import com.eu.arcturus.plugin.events.emulator.EmulatorStartShutdownEvent;
import com.eu.arcturus.plugin.events.emulator.EmulatorStoppedEvent;
import com.eu.arcturus.threading.ThreadPooling;
import com.eu.arcturus.util.imager.badges.BadgeImager;
...
public final class Emulator {
    ...
    private static com.eu.arcturus.networking.restapi.RestApiServer restApiServer;
    ...
    public static void startServer() throws Exception {
        ...
        if (Emulator.getConfig().getBoolean("api.enabled", false)) {
            ...
            Emulator.restApiServer = new com.eu.arcturus.networking.restapi.RestApiServer(apiHost, apiPort, apiToken);
