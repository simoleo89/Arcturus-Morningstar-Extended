...
import com.eu.arcturus.habbohotel.catalog.*;
import com.eu.arcturus.habbohotel.catalog.layouts.*;
...
import com.eu.arcturus.messages.outgoing.catalog.AlertPurchaseFailedComposer;
import com.eu.arcturus.messages.outgoing.catalog.AlertPurchaseUnavailableComposer;
...
import com.eu.arcturus.messages.outgoing.generic.alerts.HotelWillCloseInMinutesComposer;
import com.eu.arcturus.messages.outgoing.inventory.InventoryRefreshComposer;
import com.eu.arcturus.messages.outgoing.navigator.CanCreateRoomComposer;
...
import static com.eu.arcturus.messages.incoming.catalog.CheckPetNameEvent.PET_NAME_LENGTH_MAXIMUM;
import static com.eu.arcturus.messages.incoming.catalog.CheckPetNameEvent.PET_NAME_LENGTH_MINIMUM;
        ...
        if (Emulator.getIntUnixTimestamp() - this.client.getHabbo().getHabboStats().lastPurchaseTimestamp >= CatalogManager.PURCHASE_COOLDOWN) {
            ...
            if (pageId == -12345678 || pageId == -1) {
                ...
                if (page instanceof RoomBundleLayout) {
                    ...
                    page.getCatalogItems().values().forEach(object -> {
                        item[0] = object;
                        return false;
                    });
