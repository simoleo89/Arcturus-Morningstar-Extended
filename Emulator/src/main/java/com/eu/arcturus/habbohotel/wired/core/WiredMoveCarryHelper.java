package com.eu.arcturus.habbohotel.wired.core;
...
import com.eu.arcturus.habbohotel.rooms.RoomUnitType;
import com.eu.arcturus.habbohotel.users.Habbo;
import com.eu.arcturus.habbohotel.users.HabboItem;
import com.eu.arcturus.messages.ServerMessage;
import com.eu.arcturus.messages.outgoing.rooms.WiredMovementsComposer;
...
public final class WiredMoveCarryHelper {
    ...
    public static Double resolveFollowerStackZ(Room room, HabboItem movingItem, RoomTile targetTile, int rotation) {
        ...
        HashSet<RoomTile> occupiedTiles = room.getLayout().getTilesAt(
                targetTile,
    ...
    private static boolean hasMovementBehaviorExtra(Room room, HabboItem stackItem) {
        HashSet<InteractionWiredExtra> extras = getMovementExtras(room, stackItem);
    ...
    private static boolean isEligibleUser(Room room, HabboItem movingItem, RoomUnit roomUnit, HashSet<RoomTile> occupiedTiles, int carryMode) {
        if (roomUnit == null
    ...
    private static boolean occupiesMovingFurni(HashSet<RoomTile> occupiedTiles, RoomUnit roomUnit) {
        for (RoomTile occupiedTile : occupiedTiles) {
            if (occupiedTile != null
    ...
    private static HashSet<InteractionWiredExtra> getMovementExtras(Room room, HabboItem stackItem) {
