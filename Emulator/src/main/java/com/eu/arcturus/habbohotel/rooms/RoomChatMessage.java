...
import com.eu.arcturus.core.DatabaseLoggable;
    ...
    public void serialize(ServerMessage message) {
        ...
        try {
            ...
            if (this.habbo != null && this.habbo.getInventory() != null && this.habbo.getInventory().getPrefixesComponent() != null) {
                com.eu.arcturus.habbohotel.users.UserPrefix activePrefix = this.habbo.getInventory().getPrefixesComponent().getActivePrefix();
