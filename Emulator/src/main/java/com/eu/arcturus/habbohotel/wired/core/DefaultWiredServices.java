...
import com.eu.arcturus.threading.runnables.RoomUnitTeleport;
import com.eu.arcturus.threading.runnables.SendRoomUnitEffectComposer;
...
public final class DefaultWiredServices implements WiredServices {
    ...
    public void giveHandItem(Room room, RoomUnit user, int handItemId) {
        ...
        room.sendComposer(new com.eu.arcturus.messages.outgoing.rooms.users.RoomUserHandItemComposer(user).compose());
    }
    ...
    public void botSetClothes(Room room, String botName, String figure) {
        ...
        for (Bot bot : bots) {
            ...
            room.sendComposer(new com.eu.arcturus.messages.outgoing.rooms.users.RoomUsersComposer(bot).compose());
        }
    }
    ...
    public void resetTimers(Room room) {
        ...
        room.getRoomSpecialTypes().getTriggers().forEach(trigger -> {
            if (trigger instanceof com.eu.arcturus.habbohotel.items.interactions.wired.WiredTriggerReset) {
                ((com.eu.arcturus.habbohotel.items.interactions.wired.WiredTriggerReset) trigger).resetTimer();
            }
        });
    }
}
