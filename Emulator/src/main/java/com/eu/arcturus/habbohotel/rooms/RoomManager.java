...
import com.eu.arcturus.core.RoomUserPetComposer;
...
import com.eu.arcturus.habbohotel.games.football.FootballGame;
import com.eu.arcturus.habbohotel.games.freeze.FreezeGame;
import com.eu.arcturus.habbohotel.games.tag.BunnyrunGame;
import com.eu.arcturus.habbohotel.games.tag.IceTagGame;
import com.eu.arcturus.habbohotel.games.tag.RollerskateGame;
...
import com.eu.arcturus.habbohotel.navigation.NavigatorFilterComparator;
import com.eu.arcturus.habbohotel.navigation.NavigatorFilterField;
...
import com.eu.arcturus.habbohotel.pets.PetData;
...
import com.eu.arcturus.habbohotel.users.*;
import com.eu.arcturus.habbohotel.wired.core.WiredManager;
import com.eu.arcturus.messages.incoming.users.UserNuxEvent;
import com.eu.arcturus.messages.outgoing.generic.alerts.GenericErrorMessagesComposer;
import com.eu.arcturus.messages.outgoing.hotelview.HotelViewComposer;
import com.eu.arcturus.messages.outgoing.polls.PollStartComposer;
import com.eu.arcturus.messages.outgoing.polls.infobus.SimplePollAnswersComposer;
import com.eu.arcturus.messages.outgoing.polls.infobus.SimplePollStartComposer;
import com.eu.arcturus.messages.outgoing.rooms.*;
import com.eu.arcturus.messages.outgoing.rooms.items.RoomFloorItemsComposer;
import com.eu.arcturus.messages.outgoing.rooms.items.RoomWallItemsComposer;
import com.eu.arcturus.messages.outgoing.rooms.pets.RoomPetComposer;
import com.eu.arcturus.messages.outgoing.rooms.promotions.RoomPromotionMessageComposer;
import com.eu.arcturus.messages.outgoing.rooms.users.*;
import com.eu.arcturus.messages.outgoing.users.MutedWhisperComposer;
import com.eu.arcturus.plugin.events.navigator.NavigatorRoomCreatedEvent;
import com.eu.arcturus.plugin.events.rooms.RoomFloorItemsLoadEvent;
import com.eu.arcturus.plugin.events.rooms.RoomUncachedEvent;
import com.eu.arcturus.plugin.events.rooms.UserVoteRoomEvent;
import com.eu.arcturus.plugin.events.users.HabboAddedToRoomEvent;
import com.eu.arcturus.plugin.events.users.UserEnterRoomEvent;
import com.eu.arcturus.plugin.events.users.UserExitRoomEvent;
...
public class RoomManager {
    ...
    private final HashMap<Integer, RoomCategory> roomCategories;
    ...
    public HashMap<Integer, List<Room>> findRooms(NavigatorFilterField filterField, String value, int category, boolean showInvisible) {
        HashMap<Integer, List<Room>> rooms = new HashMap<>();
    ...
    public HashMap<Integer, RoomCategory> getRoomCategories() {
    ...
    public void clearInactiveRooms() {
        HashSet<Room> roomsToDispose = new HashSet<>();
        for (Room room : this.activeRooms.values()) {
    ...
    public void enterRoom(final Habbo habbo, final Room room) {
        ...
        {
            final HashSet<HabboItem> floorItems = new HashSet<>();

            HashSet<HabboItem> allFloorItems = new HashSet<>(room.getFloorItems());
            ...
            allFloorItems.forEach(new Consumer<HabboItem>() {
                @Override
        ...
        HashMap<Integer, String> guildBadges = new HashMap<>();
    ...
    public ArrayList<Room> getRoomsFavourite(Habbo habbo) {
        ...
        habbo.getHabboStats().getFavoriteRooms().forEach(new IntConsumer() {
            @Override
