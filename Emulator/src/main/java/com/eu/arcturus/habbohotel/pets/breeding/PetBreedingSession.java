package com.eu.arcturus.habbohotel.pets.breeding;
...
public class PetBreedingSession {
    ...
    public void cancel(String reason) {
        ...
        if (this.nest.getRoomId() > 0) {
            com.eu.arcturus.habbohotel.rooms.Room room = com.eu.arcturus.Emulator.getGameEnvironment().getRoomManager().getRoom(this.nest.getRoomId());
            if (room != null) {
