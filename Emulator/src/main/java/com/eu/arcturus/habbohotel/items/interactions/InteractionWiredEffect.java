...
import com.eu.arcturus.messages.outgoing.wired.WiredEffectDataComposer;
 ...
 *   <li>{@link #serializeWiredData(com.eu.arcturus.messages.ServerMessage, Room)} - Sends config to client</li>
 * </ul>
 * </p>
 * 
 * @see InteractionWiredTrigger
 * @see InteractionWiredCondition
 * @see com.eu.arcturus.habbohotel.wired.core.WiredManager
 */
