...
import com.eu.arcturus.habbohotel.items.interactions.InteractionStackHelper;
import com.eu.arcturus.habbohotel.items.interactions.InteractionTileWalkMagic;
import com.eu.arcturus.habbohotel.users.HabboItem;
import com.eu.arcturus.plugin.events.furniture.FurnitureStackHeightEvent;
...
public class RoomTileManager {
    ...
    public void updateTiles(HashSet<RoomTile> tiles) {
        ...
        this.room.sendComposer(new com.eu.arcturus.messages.outgoing.rooms.UpdateStackHeightComposer(this.room, tiles).compose());
    }
