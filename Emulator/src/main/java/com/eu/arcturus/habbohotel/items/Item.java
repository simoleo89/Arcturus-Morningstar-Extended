...
import com.eu.arcturus.habbohotel.items.interactions.InteractionMultiHeight;
...
public class Item implements ISerialize {
    ...
    private ArrayList<Integer> vendingItems;
    ...
    public ArrayList<Integer> getVendingItems() {
