...
public class FloorItemOnRollerComposer extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        if(this.oldLocation == null) {
            ...
            HashSet<RoomTile> tiles = this.room.getLayout().getTilesAt(this.room.getLayout().getTile(oldX, oldY), this.item.getBaseItem().getWidth(), this.item.getBaseItem().getLength(), this.item.getRotation());
