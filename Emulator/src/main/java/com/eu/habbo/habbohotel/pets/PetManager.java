...
public class PetManager {
    ...
    private final HashMap<Integer, Int2ObjectOpenHashMap<ArrayList<PetBreedingReward>>> breedingReward;
    ...
    public Int2ObjectOpenHashMap<ArrayList<PetBreedingReward>> getBreedingRewards(int petType) {
    ...
    public int getRarityForOffspring(Pet pet) {
        ...
        Int2ObjectOpenHashMap<ArrayList<PetBreedingReward>> offspringList = this.breedingReward.get(pet.getPetData().getType());

        for (Int2ObjectMap.Entry<ArrayList<PetBreedingReward>> e : offspringList.int2ObjectEntrySet()) {
            int i = e.getIntKey();
            ArrayList<PetBreedingReward> petBreedingRewards = e.getValue();
            boolean found = false;
