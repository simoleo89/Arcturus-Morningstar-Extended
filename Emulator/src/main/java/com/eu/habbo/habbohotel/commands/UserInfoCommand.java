...
public class UserInfoCommand extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        for (Map.Entry<Integer, Integer> entry : habbo.getCurrencies().entrySet()) {
            message.append(Emulator.getTexts().getValue("seasonal.name." + entry.getKey())).append(": ").append(entry.getValue()).append("\r");
        }
